...
*-descending order
*/
multiset<int,greater<int>> coll1; // empty multiset container
...
multiset<int,greater<int>> coll1::iterator pos;
for (pos = coll1.begin(); pos != coll1.end(); ++pos) {
cout << *pos << ' ';
}
cout << endl;
//insert 4 again and process return value
multiset<int,greater<int>> ::iterator ipos = coll1.insert(4);
